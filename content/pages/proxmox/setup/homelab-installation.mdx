...
If remote recovery is part of the design, do not treat that row as a universal rule. Read [Wake-on-LAN For Proxmox](/pages/jetkvm/wake-on-lan-for-proxmox) and enable it on purpose instead of by habit.
