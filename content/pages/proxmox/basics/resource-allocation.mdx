...
If that last line is becoming real instead of hypothetical, [Kubernetes On Proxmox With k3s](/pages/proxmox/workloads/kubernetes) is the concrete cluster build that matches this sizing advice.
...
- [Proxmox Fundamentals](/pages/proxmox/basics/proxmox-fundamentals) — the big-picture reference for the concepts underneath these sizing choices.
- [Why I Use Proxmox](/pages/proxmox/basics/why-i-use-proxmox) — the personal case for why this overhead is usually worth it.
- [Proxmox](/pages/proxmox) — the full section index if you want to jump back into the rest of the series.