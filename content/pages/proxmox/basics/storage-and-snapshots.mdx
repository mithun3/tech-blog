...
- [Proxmox Fundamentals](/pages/proxmox/basics/proxmox-fundamentals) — the higher-level reference on snapshots, templates, nodes, and migration.
- [Networking Models](/pages/proxmox/basics/networking-models) — how those guests should join the LAN once their disks are in order.
- [Resource Allocation](/pages/proxmox/basics/resource-allocation) — how to size CPU, RAM, and disk without starving the host.