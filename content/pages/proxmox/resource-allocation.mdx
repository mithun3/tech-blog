...
- [Proxmox Fundamentals](/pages/proxmox/proxmox-fundamentals) — the big-picture reference for the concepts underneath these sizing choices.
- [Why I Use Proxmox](/pages/proxmox/why-i-use-proxmox) — the personal case for why this overhead is usually worth it.
