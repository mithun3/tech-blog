...
- [Proxmox Fundamentals](/pages/proxmox/proxmox-fundamentals) — the reference overview of Type 1 virtualization, VM versus LXC choices, and the main platform concepts.
- [Storage and Snapshots](/pages/proxmox/storage-and-snapshots) — where the platform stops being abstract and starts depending on real disk behavior.
- [Networking Models](/pages/proxmox/networking-models) — how guests actually attach to the network once the stack is in place.