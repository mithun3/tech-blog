...
If [Why I Use Proxmox](/pages/proxmox/why-i-use-proxmox) is the personal answer, this page is the structural one.
...
- [Why I Use Proxmox](/pages/proxmox/why-i-use-proxmox) — the opinionated, first-person case for choosing it in the first place.
- [Proxmox Stack](/pages/proxmox/proxmox-stack) — the platform layers, boundaries, and operating model.
- [Storage and Snapshots](/pages/proxmox/storage-and-snapshots) — the part of the platform that usually decides whether the lab feels safe or fragile.