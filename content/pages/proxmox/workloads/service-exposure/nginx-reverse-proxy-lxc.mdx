...
If one wildcard certificate feels too broad but one certificate per service feels excessive, continue later to [SAN Certificates On Proxmox With Certbot](/pages/proxmox/workloads/service-exposure/san-certificates-certbot).
...
- [SAN Certificates On Proxmox With Certbot](/pages/proxmox/workloads/service-exposure/san-certificates-certbot) - the grouped-certificate middle ground when one wildcard no longer feels like the right blast radius.
...
- [Traefik On Proxmox](/pages/proxmox/workloads/service-exposure/traefik) - the container-native alternative when routing should follow labels instead of static site files.
