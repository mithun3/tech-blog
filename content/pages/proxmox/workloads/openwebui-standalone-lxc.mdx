If the lab already standardised on [llama.cpp Inference On Proxmox](/pages/proxmox/workloads/llamacpp) or [llama.cpp Router Mode On Proxmox](/pages/proxmox/workloads/llamacpp/router-mode), the same OpenAI-compatible connection flow applies here.
---
...
If the lab already standardised on [llama.cpp Inference On Proxmox](/pages/proxmox/workloads/llamacpp-inference-lxc) or [llama.cpp Router Mode On Proxmox](/pages/proxmox/workloads/llamacpp-router-mode), the same OpenAI-compatible connection flow applies here. The commands below keep the original remote-backend values from the source notes so the working examples stay intact.
...
- [llama.cpp Inference On Proxmox](/pages/proxmox/workloads/llamacpp-inference-lxc) - the lower-level OpenAI-compatible backend when you want tighter runtime control.
