...
Replace the single-model `llama-server.service` from [llama.cpp Inference On Proxmox](/pages/proxmox/workloads/llamacpp-inference-lxc) with a router-mode service.
...
- [llama.cpp Inference On Proxmox](/pages/proxmox/workloads/llamacpp-inference-lxc) — the single-model setup this page builds on.
