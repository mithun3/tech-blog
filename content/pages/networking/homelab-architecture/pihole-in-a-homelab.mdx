...
If you are ready to deploy a platform-specific instance, continue to [Pi-hole On Raspberry Pi 4B](/pages/hardware/sbc/rpi-4b) for a dedicated Pi node or [Pi-hole LXC On Proxmox](/pages/proxmox/workloads/pihole-lxc) for the Proxmox-backed path.
...
That platform page is here: [Pi-hole On Raspberry Pi 4B](/pages/hardware/sbc/rpi-4b).

## Related Topics

- [Pi-hole On Raspberry Pi 4B](/pages/hardware/sbc/rpi-4b) — the dedicated Pi deployment path for a primary or standalone Pi-hole node.
