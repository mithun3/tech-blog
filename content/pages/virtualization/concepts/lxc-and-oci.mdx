...
If that guest now needs to become a real cluster instead of one more handcrafted box, [Kubernetes On Proxmox With k3s](/pages/proxmox/workloads/kubernetes) is the Proxmox-side runbook.
...
For Docker specifically — how images work, how Compose fits in, and when to reach for it instead of LXC — see [Docker](/pages/virtualization/concepts/docker).