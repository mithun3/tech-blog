...
- [Proxmox Fundamentals](/pages/virtualization/proxmox/proxmox-fundamentals) — the big-picture reference for the concepts underneath these sizing choices.
- [Why I Use Proxmox](/pages/virtualization/proxmox/why-i-use-proxmox) — the personal case for why this overhead is usually worth it.
- [Proxmox Platform](/pages/virtualization/proxmox) — the full section index if you want to jump back into the rest of the series.