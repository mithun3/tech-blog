...
- [Proxmox Fundamentals](/pages/virtualization/proxmox/proxmox-fundamentals) — the reference version of what Proxmox is, how it works, and where it sits against alternatives.
- [Proxmox Stack](/pages/virtualization/proxmox/proxmox-stack) — the architectural view of the layers and boundaries underneath the platform.
- [Storage and Snapshots](/pages/virtualization/proxmox/storage-and-snapshots) — the recovery and rollback side of the story in more concrete detail.
