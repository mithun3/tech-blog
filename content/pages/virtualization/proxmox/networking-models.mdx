...
- [Proxmox Stack](/pages/virtualization/proxmox/proxmox-stack) — the wider platform view if you want to reconnect networking to the rest of the stack.
- [Storage and Snapshots](/pages/virtualization/proxmox/storage-and-snapshots) — because guests with good networking and bad storage are still a bad day.
- [Resource Allocation](/pages/virtualization/proxmox/resource-allocation) — the practical sizing pass once the attachment model is decided.