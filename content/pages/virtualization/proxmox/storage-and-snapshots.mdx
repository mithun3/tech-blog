...
- [Proxmox Fundamentals](/pages/virtualization/proxmox/proxmox-fundamentals) — the higher-level reference on snapshots, templates, nodes, and migration.
- [Networking Models](/pages/virtualization/proxmox/networking-models) — how those guests should join the LAN once their disks are in order.
- [Resource Allocation](/pages/virtualization/proxmox/resource-allocation) — how to size CPU, RAM, and disk without starving the host.