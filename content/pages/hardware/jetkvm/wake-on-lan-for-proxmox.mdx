...
- For the Raspberry Pi client build, use [JetKVM Admin Terminal On Raspberry Pi 3](/pages/hardware/sbc/jetkvm-admin-terminal).
...
- [JetKVM Admin Terminal On Raspberry Pi 3](/pages/hardware/sbc/jetkvm-admin-terminal) - the small dedicated client if you want the console and the sender close to the rack.
