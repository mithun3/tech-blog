...
- For the small browser terminal path, use [JetKVM Admin Terminal On Raspberry Pi 3](/pages/hardware/sbc/jetkvm-admin-terminal).
...
- [JetKVM Admin Terminal On Raspberry Pi 3](/pages/hardware/sbc/jetkvm-admin-terminal) - use a small dedicated Pi as the client-side console terminal.
